...
Spring Content is a multi-module Java 25 / Maven library (group `it.intesys`, Spring Boot 4.x) for managing binary content and associating it with Spring Data entities across pluggable storage backends. It is a **fork** of `paulcwarren/spring-content`, maintained by Intesys.
