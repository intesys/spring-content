...
@DisplayName("ContentRestAutoConfiguration")
public class ContentRestAutoConfigurationTest {
	...
	@Nested
	@DisplayName("given an environment specifying rest properties")
	class RestProperties {
		...
		@Test
		@DisplayName("should have a filesystem properties bean with the correct properties set")
