...
public class PostgresBlobResourceIT {
    ...
    @Nested
    @DisplayName("PostgresBlobResource")
    class Postgresblobresource {
        ...
        @Nested
        @DisplayName("given there is content")
        class GivenThereIsContent {
            ...
            class WhenTheContentIsDeleted {
                ...
                @Test
                @DisplayName("should delete the associated lob resources")
                void shouldDeleteTheAssociatedLobResources() throws Exception {
