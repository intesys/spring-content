...
public class Azurite extends GenericContainer<Azurite> implements Serializable {
    ...
    private Azurite() {
        ...
        // Accept the (newer) x-ms-version sent by the Azure SDK; without
        // --skipApiVersionCheck Azurite rejects unknown API versions with HTTP
        // 400 InvalidHeaderValue. Replicates the image's default CMD and appends
        // the flag.
