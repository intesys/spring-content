...
https://github.com/intesys/spring-content/spring-versions-jpa[Spring Version Commons].
...
dependencies {
    ...
    compile("it.intesys:spring-versions-jpa-boot-starter:${version}")
	... 
}
----
====
...
dependencies {
    ...
    compile("it.intesys:spring-versions-jpa:${version}")
	... 
}
----
====
...
when you place `it.intesys:spring-versions-jpa-boot-starter` on your application's classpath and your application
